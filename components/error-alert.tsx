...
const ErrorAlert = ({header, message}: IErrorAlertProps) => {
    return <div className="alert flex flex-row items-center bg-red-200 p-5 rounded border-b-2 border-red-300">
        <div
